<article class="card">
    <a class="card-media" href="<?= url('/yazi/' . $article['slug']) ?>">
        ...
        <?php else: ?>
            <div class="card-placeholder"><span><?= e(mb_strtoupper(mb_substr($article['title'], 0, 1))) ?></span></div>
        <?php endif; ?>
    </a>
    <div class="card-body">
        <div class="card-meta">
        ...
        <a class="card-link" href="<?= url('/yazi/' . $article['slug']) ?>">Yazıyı oku <span aria-hidden="true">→</span></a>
    </div>
</article>
